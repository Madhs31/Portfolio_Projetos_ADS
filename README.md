...
| Semestre | Projeto | Parceiro de Negócio | Resumo do Escopo | Documentação |
| :---: | :--- | :---: | :--- | :---: |
| **1º** | **Aprenda Scrum** | *FATEC* | Sistema Web interativo e gamificado com foco no ensino prático da Metodologia Ágil. | [🔗 Ver mais](https://github.com/Madhs31/Portfolio_Projetos_ADS/tree/main/API_1Sem) |
| **2º** | **MindDoc Analyzer** | *FATEC* | Software focado na extração estruturada de informações e armazenamento de relatórios clínicos. | [🔗 Ver mais](https://github.com/Madhs31/Portfolio_Projetos_ADS/tree/main/API_2Sem) |
